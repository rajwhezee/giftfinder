...
const QUERIES: CuratedQuery[] = [
  ...
  // word and no listing names two competitors.
  {
    ...
    minPrice: 150,
    maxPrice: 3000,
    interests: ["Hype", "Art", "Creativity"],
    occasions: ["Birthday", "Christmas", "New Year", "Graduation", "Valentine's Day", "Anniversary"],
    ageMin: 16,
    ageMax: 45,
  },
  {
  ...
  },
  {
    ...
    minPrice: 300,
    maxPrice: 3000,
    interests: ["Hype", "Sneakers", "Fashion"],
    occasions: ["Birthday", "Christmas", "New Year", "Graduation", "Valentine's Day", "Anniversary"],
    ageMin: 16,
    ageMax: 40,
  },
  ...
  },
  {
    ...
    minPrice: 200,
    maxPrice: 2500,
    interests: ["Hype", "Fashion", "Sneakers"],
    occasions: ["Birthday", "Christmas", "New Year", "Graduation", "Valentine's Day", "Anniversary"],
    ageMin: 16,
    ageMax: 40,
  },
  {
    ...
    minPrice: 300,
    maxPrice: 4000,
    interests: ["Hype", "Fashion", "Jewelry"],
    occasions: ["Birthday", "Christmas", "New Year", "Graduation", "Valentine's Day", "Anniversary"],
    ageMin: 18,
    ageMax: 45,
  },
