...
const QUERIES: CuratedQuery[] = [
  // --- Culturally specific gifts, added 2026-08-23 ---
  //
  // The niche occasion pages were thin and, where a brand-level occasion
  // list had widened them, mostly generic: Raksha Bandhan held 1,810 gifts
  // of which 4% were culturally apt. Etsy is where handmade cultural goods
  // actually live, and every viable alternative was checked first - the
  // Mexican, Indian and Irish Shopify storefronts either block
  // /products.json, serve HTML, or price in INR.
  //
  // Each query names only the occasions the object genuinely belongs to.
  {
    keywords: "talavera pottery mexican",
    interests: ["Home Decor", "Art"],
    occasions: ["Quinceañera", "Housewarming", "Birthday"],
    ageMin: 16,
    ageMax: 80,
    maxPrice: 200,
  },
  {
    keywords: "papel picado banner",
    interests: ["Home Decor", "Art"],
    occasions: ["Day of the Dead", "Quinceañera", "Carnival"],
    ageMin: 16,
    ageMax: 80,
    maxPrice: 90,
  },
  {
    keywords: "otomi embroidered mexican",
    interests: ["Home Decor", "Art", "Fashion"],
    occasions: ["Quinceañera", "Housewarming", "Day of the Dead"],
    ageMin: 16,
    ageMax: 80,
    maxPrice: 250,
  },
  {
    ...
    occasions: ["Quinceañera", "Birthday"],
    ageMin: 14,
    ageMax: 25,
    maxPrice: 200,
  },
  {
    keywords: "dia de los muertos catrina",
    interests: ["Home Decor", "Art"],
  ...
  {
    keywords: "mexican silver filigree earrings",
    interests: ["Jewelry", "Fashion"],
    occasions: ["Quinceañera", "Birthday", "Mother's Day"],
    ageMin: 14,
    ageMax: 80,
    maxPrice: 180,
  },
  {
    keywords: "handmade rakhi set",
    interests: ["Personalized", "Family", "Art"],
  ...
  {
    keywords: "brass diya oil lamp indian",
    interests: ["Home Decor", "Art"],
  ...
  {
    keywords: "rangoli stencil diwali",
    interests: ["Home Decor", "Creativity", "Art"],
    occasions: ["Diwali"],
    ageMin: 14,
    ageMax: 80,
    maxPrice: 60,
  ...
  {
    keywords: "kundan jhumka earrings indian",
    interests: ["Jewelry", "Fashion"],
    occasions: ["Diwali", "Raksha Bandhan", "Onam", "Wedding"],
    ageMin: 14,
    ageMax: 80,
    maxPrice: 200,
  },
  {
    keywords: "chikankari kurta handmade",
    interests: ["Fashion"],
    occasions: ["Diwali", "Eid al-Fitr", "Onam", "Raksha Bandhan"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 250,
  },
  {
    keywords: "madhubani painting handmade",
    interests: ["Art", "Home Decor"],
    occasions: ["Diwali", "Housewarming", "Onam"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 300,
  },
  {
    keywords: "holi color powder gift set",
  ...
  {
    keywords: "kerala kasavu saree onam",
    interests: ["Fashion"],
    occasions: ["Onam", "Diwali"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 300,
  },
  {
    keywords: "sikh khanda ik onkar gift",
    interests: ["Personalized", "Art"],
    occasions: ["Vaisakhi", "Birthday"],
    ageMin: 12,
    ageMax: 90,
    maxPrice: 120,
  },
  {
    keywords: "eid gift set islamic",
    interests: ["Personalized", "Home Decor"],
  ...
  {
    keywords: "arabic calligraphy wall art",
    interests: ["Art", "Home Decor"],
    occasions: ["Eid al-Fitr", "Eid al-Adha", "Housewarming"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 300,
  },
  {
    keywords: "tasbih prayer beads handmade",
    interests: ["Self-care", "Personalized"],
    occasions: ["Eid al-Fitr", "Eid al-Adha"],
    ageMin: 12,
    ageMax: 90,
    maxPrice: 90,
  ...
  {
    keywords: "lunar new year red envelope set",
    interests: ["Personalized", "Art"],
  ...
  {
    keywords: "chinese zodiac figurine",
    interests: ["Home Decor", "Art"],
    occasions: ["Lunar New Year", "Birthday"],
    ageMin: 12,
    ageMax: 90,
    maxPrice: 150,
  },
  ...
  {
    keywords: "cheongsam qipao handmade",
    interests: ["Fashion"],
    occasions: ["Lunar New Year"],
    ageMin: 16,
    ageMax: 80,
  ...
  {
    keywords: "claddagh ring sterling silver",
    interests: ["Jewelry", "Fashion"],
    occasions: ["St. Patrick's Day", "Anniversary", "Valentine's Day"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 200,
  },
  {
    keywords: "aran wool sweater irish",
    interests: ["Fashion"],
    occasions: ["St. Patrick's Day", "Christmas", "Birthday"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 300,
  },
  {
    keywords: "celtic knot wall art",
    interests: ["Art", "Home Decor"],
    occasions: ["St. Patrick's Day", "Housewarming"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 200,
  },
  {
    keywords: "german beer stein handmade",
    interests: ["Home Decor", "Art"],
    occasions: ["Oktoberfest", "Father's Day", "Birthday"],
    ageMin: 21,
    ageMax: 90,
    maxPrice: 250,
  },
  {
    keywords: "bavarian dirndl apron",
    interests: ["Fashion"],
  ...
  {
    keywords: "handmade seder plate judaica",
    interests: ["Home Decor", "Art", "Family"],
    occasions: ["Passover"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 250,
  ...
  {
    keywords: "menorah handmade modern",
    interests: ["Home Decor", "Art"],
    occasions: ["Hanukkah", "Housewarming"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 250,
  },
  {
    keywords: "bar mitzvah tallit personalized",
    interests: ["Personalized", "Family"],
  ...
  {
    keywords: "kente cloth handmade african",
    interests: ["Fashion", "Art"],
    occasions: ["Kwanzaa", "Graduation"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 250,
  },
  {
    keywords: "adinkra ankara print gift",
    interests: ["Fashion", "Home Decor", "Art"],
    occasions: ["Kwanzaa", "Birthday"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 200,
  },
  {
    keywords: "persian haft seen nowruz",
    interests: ["Home Decor", "Art", "Family"],
    occasions: ["Nowruz"],
    ageMin: 18,
    ageMax: 90,
  ...
  {
    keywords: "turquoise persian jewelry",
    interests: ["Jewelry", "Fashion"],
    occasions: ["Nowruz", "Birthday"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 200,
  },
  {
    keywords: "tibetan mala prayer beads",
    interests: ["Self-care", "Health"],
    occasions: ["Vesak", "Just Because"],
    ageMin: 16,
    ageMax: 90,
    maxPrice: 120,
  },
  {
    keywords: "lotus buddha home decor handmade",
    interests: ["Home Decor", "Art", "Self-care"],
    occasions: ["Vesak", "Housewarming"],
    ageMin: 18,
    ageMax: 90,
    maxPrice: 200,
  },
